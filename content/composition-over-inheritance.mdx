...
With inheritance, you structure your classes around **<Highlight type="underline" content="what they are."  color="var(--color-text-accent)"/>** With functional programming, you structure your classes on **<Highlight type="underline" color="var(--color-text-accent)" content="what they do" delay={4000}/>**.
